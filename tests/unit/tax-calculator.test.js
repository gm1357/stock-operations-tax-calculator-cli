...
describe('calculateManyLedgersTaxes', () => {
  ...
  it(
    'should calculate taxes correctly for Case #1 + Case #2',
    { skip: true },
    { todo: true },
    () => {
      const ledgers = [
  ...
  it(
    'should calculate taxes correctly for Case #3',
    { skip: true },
    { todo: true },
    () => {
      const ledgers = [
  ...
  it(
    'should calculate taxes correctly for Case #4',
    { skip: true },
    { todo: true },
    () => {
      const ledgers = [
  ...
  it(
    'should calculate taxes correctly for Case #5',
    { skip: true },
    { todo: true },
    () => {
      const ledgers = [
  ...
  it(
    'should calculate taxes correctly for Case #6',
    { skip: true },
    { todo: true },
    () => {
      const ledgers = [
  ...
  it(
    'should calculate taxes correctly for Case #7',
    { skip: true },
    { todo: true },
    () => {
      const ledgers = [
  ...
  it(
    'should calculate taxes correctly for Case #8',
    { skip: true },
    { todo: true },
    () => {
      const ledgers = [
  ...
  it(
    'should calculate taxes correctly for Case #9',
    { skip: true },
    { todo: true },
    () => {
      const ledgers = [
